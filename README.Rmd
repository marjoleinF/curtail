...
If we want to obtain tables with item-specific cutoff values, we can use the ```stochTable``` function (for stochastic curtailment, note that by default, gamma values of .95 are employed):
